...
export default function DextopSidebar({ windowWidth, showHeader, setShowHeader, baseSidebarClasses, groupedItems }) {
  return (
    <>
      {windowWidth >= 768 && (
        <motion.section
              ...
              <section>
                <div className="px-3 py-3 flex flex-col gap-2">
                  <article className="flex justify-center items-center p-2 mb-3">
                    <div onClick={() => setShowHeader(true)}>
                      <ToggleBtn size={25} />
                    </div>
                  </article>
                  ...
                  <div
                    ...
                    className="bg-[#121212] hover:bg-[#1f1f22] flex items-center justify-between p-2 mb-2"
                  >
